    ...
    return (
        <>
            ...
            <button
                ...
                className="fixed md:hidden bottom-4 left-4 z-50 p-3 rounded-full bg-[var(--primary)] text-[var(--on-primary)] shadow-lg"
            >
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
                     stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        ...
        bg-[var(--surface-container-lowest)] border-r border-[var(--outline-variant)]
                  ...
                  `}>
                      ...
                      `}>
                        {item.name}
                                        ...
                                        {isExpanded && (
                                            <span className="ml-4 text-[var(--on-surface)] font-medium">
                        {item.name}
                      </span>
                                        )}
                                    </div>
                    ...
                    <div className="mt-auto px-2 pb-6 hidden md:block">
                        <button
                            onClick={() => setIsExpanded(!isExpanded)}
                            className="flex items-center p-3 rounded-lg cursor-pointer hover:bg-[var(--surface-container-high)] transition-colors"
                        >
                            ...
                            {isExpanded && (
                                <span className="ml-4 text-[var(--on-surface)]">Collapse</span>
                            )}
                        </button>
                    </div>
                </nav>
